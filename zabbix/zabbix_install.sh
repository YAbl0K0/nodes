...
if [[ "$UBUNTU_VERSION" == "20" ]]; then
    echo "Ubuntu 20.04 detected. Running install_zabbix.sh..."
     . <(wget -qO- https://raw.githubusercontent.com/VadimRM7/zabix_ALL/main/install_zabbix.sh)
elif [[ "$UBUNTU_VERSION" == "22" ]]; then
    echo "Ubuntu 22.04 detected. Running install_zabbix22_04.sh..."
     . <(wget -qO- https://github.com/VadimRM7/zabix_ALL/raw/refs/heads/main/install_zabbix22_04.sh)
else
