...
while 1 {
    ...
    expect {
        ...
        "If you are upgrading from a previous version, please specify the directory where it was installed. What base directory should the node use (default ~/shardeum):" {send "\r"; exp_continue}
